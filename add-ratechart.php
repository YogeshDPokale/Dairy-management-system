...
for($i=0;$i<=$x;$i++)
{   
    $q1=mysqli_query($con,"INSERT INTO `fat`(`id1`,`Fat`) VALUES ('$id1','$y')");
    if($q1){
        $y=$y+0.1;
        $id1++;
    }
...
for($i=0;$i<=$u;$i++)
{   
    $q2=mysqli_query($con,"INSERT INTO `snf`(`id2`,`SNF`) VALUES ('$id2','$z')");
    if($q2){
        $z=$z+0.1;
        $id2++;
    }
...
{    
    ...
    {   
        ...
        $q3=mysqli_query($con,"INSERT INTO `rate`(`id1`, `id2`, `Rate`) VALUES ('$id1','$id2','$rate1')"); 
                $rate1=$rate1-$d;
           $snf=$snf-0.1;
            $id2--;
    }
    ...
    for($l=$i;$l>=0;$l--)
    {   
         $q4=mysqli_query($con,"INSERT INTO `rate`(`id1`, `id2`, `Rate`) VALUES ('$id1','$id2','$rate1')"); 
         $rate1=$rate1-$c;
        //  $snf=$snf-0.1;
         $id2--;
    }
...
{   
    ...
    {  
        //  $snf=$snf+0.1;
        $rate2=$rate2+$e;
        $q5=mysqli_query($con,"INSERT INTO `rate`(`id1`, `id2`, `Rate`) VALUES ('$id1','$id2','$rate2')"); 
      $id2++;
    }
    $id1++;
